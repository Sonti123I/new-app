...
async function loadVirtualModule(id) {
  switch (id) {
    case VIRTUAL_MODULES.startManifest:
      return await import('../_/_tanstack-start-manifest_v-m-N4UhAX.mjs');
    case VIRTUAL_MODULES.serverFnManifest:
      return await import('../_/_tanstack-start-server-fn-manifest_v-D0w9hIFj.mjs');
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import('../_/router-Bo0zeljE.mjs');
    }
    if (startEntry === null) {
...
export { createServerRpc as a, createServerFn as c, entry$1 as e };
